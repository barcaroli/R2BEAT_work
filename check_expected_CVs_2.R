...
sens_names(allocation$sensitivity,target_vars = target_vars,strata)
#    Type    Dom        Var Planned CV   Actual CV Sensitivity 10%
# 2  DOM1  Total     active       0.05 0.009645186               1
# 3  DOM1  Total   inactive       0.05 0.028127185               1
# 4  DOM1  Total unemployed       0.05 0.047239674             108
# 5  DOM1  Total  income_hh       0.05 0.014258325               1
# 6  DOM2  north     active       0.10 0.009344995               0
# 7  DOM2  north   inactive       0.10 0.033105340               1
# 8  DOM2  north unemployed       0.10 0.101320107             430
# 9  DOM2  north  income_hh       0.10 0.016663497               1
# 10 DOM2 center     active       0.10 0.026345422               1
# 11 DOM2 center   inactive       0.10 0.063890870               1
# 12 DOM2 center unemployed       0.10 0.100598171              82
# 13 DOM2 center  income_hh       0.10 0.028696307               1
# 14 DOM2  south     active       0.10 0.052671236               1
# 15 DOM2  south   inactive       0.10 0.091732032               1
# 16 DOM2  south unemployed       0.10 0.069812588               1
# 17 DOM2  south  income_hh       0.10 0.038048570               1
